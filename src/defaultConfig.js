...
export default () => {
  return {
    ...
    exportFormatDefault: ['2D Shape'],
    lodList: ['LoD1', 'LoD2', 'LoD3', 'haLoD'],
    lodDefault: 'haLoD',
    thematicClassOptions: ['26', '7', '14', '5', '21', '85', '64', '45', '43', '46', '8', '9', '4', '44'],
    ...
    termsOfUse: 'https://www.businesslocationcenter.de/berlin3d-downloadportal/templates/en/datenschutzhinweise.html',
