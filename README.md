...
| crs                      | string                        | null                                                                                                                                                                                                                             | The output crs as epsg code. If array is provided user can select. Example: ["EPSG:25832", "EPSG:3587"]. If not provided, and crs text input is not allowed, the source crs is used.                                                         |
