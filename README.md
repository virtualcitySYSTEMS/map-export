...
| key                       | type                          | default                                                                                                                                                                                                                          | description                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------------- | ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| exportFormatConfigurable  | boolean                       | true                                                                                                                                                                                                                             | Whether the user can configure the export formats. When enabled, user can choose from `exportFormatList`, with `exportFormatDefault` being preselected. If disable, `exportFormatDefault`will be used.                                                                                                                                                                                                                                                           |
...
| lodConfigurable           | boolean                       | true                                                                                                                                                                                                                             | Whether the user can configure the LOD. When enabled, user can choose from `lodList`, with `lodDefault` being preselected. If disable, `lodDefault`will be used.                                                                                                                                                                                                                                                                                                 |
...
| thematicClassConfigurable | boolean                       | true                                                                                                                                                                                                                             | Whether the user can configure the thematic classes to export. When enabled, user can choose from `thematicClassList`, with `thematicClassDefault` being preselected. If disable, `thematicClassDefault`will be used.                                                                                                                                                                                                                                            |
...
| fmeSecurityToken          | string                        | null                                                                                                                                                                                                                             | The FME security token for the given server.                                                                                                                                                                                                                                                                                                                                                                                                                     |
